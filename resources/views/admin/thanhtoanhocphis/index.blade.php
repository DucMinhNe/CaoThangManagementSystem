                            ...
                            <div class="col-md-3" style="font-size: 0.8em">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <select name="id_hoc_phi" id="id_hoc_phi" class="form-control select2"
                                            style="width: 100%;">
                                            <option value="selecthocky">Chọn học kỳ</option>
                                            @foreach ($hocphis as $hocphi)
                                            <option data-hoc-ky="{{$hocphi->hoc_ky}}"
                                                data-khoa-hoc="{{$hocphi->khoa_hoc}}">{{$hocphi->khoa_hoc}}.Học kì
                                                {{$hocphi->hoc_ky}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="id_lop_hoc" id="id_lop_hoc"
                                    ...
                                    <div class="cs-form">
                                        ...
                                        <select name="id_hinh_thuc_thanh_toan" id="id_hinh_thuc_thanh_toan"
                                            class="form-control select2" style="width: 100%;">
                                            @foreach ($hinhthucthanhtoans as $hinhthucthanhtoan)
                                            <option value="{{ $hinhthucthanhtoan->id }}">
                                                {{$hinhthucthanhtoan->ten_hinh_thuc_thanh_toan}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="paypal_payments">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="Paypal_paymentID"
                                                name="Paypal_paymentID" placeholder="Mã" value="" required>
                                        </div>
                                        <div>
                                            <a class="btn btn-success" id="btn-paypal_querydr">Truy vấn thông tin giao
                                                dịch</a>
                                        </div>
                                    </div>
                                    <div class="vnpay_payments" hidden="true">
                                        <div class="form-group">
                                            <label for="vnp_TxnReQuerydr">Mã GD thanh toán cần truy vấn
                                                (vnp_TxnRef):</label>
                                            <input type="text" class="form-control" id="vnp_TxnReQuerydr"
                                                name="vnp_TxnReQuerydr" placeholder="Mã" value="" required>
                                        </div>
                                        <div class="form-group">
                                            <label>Thời gian khởi tạo GD thanh toán (vnp_TransactionDate):</label>
                                            <input class="form-control" data-val="true" name="transactionDate"
                                                type="text" id="transactionDate" placeholder="yyyyMMddHHmmss"
                                                value="" />
                                        </div>
                                        <div>
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="paypal_payments">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="payer_email_address"
                                            name="payer_email_address" placeholder="Email" value="" readonly>
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="vnpay_payments" hidden>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="vnp_ResponseCode"
                                            name="vnp_ResponseCode" placeholder="vnp_ResponseCode" value="" readonly>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="vnp_TransactionNo"
                                            name="vnp_TransactionNo" placeholder="vnp_TransactionNo" value="" readonly>
                                    </div>
                                    <div class="form-group">
                                        <label for="vnp_TransactionStatus"> vnp_TransactionStatus </label>
                                        <input type="text" class="form-control" id="vnp_TransactionStatus"
                                            name="vnp_TransactionStatus" placeholder="vnp_TransactionStatus" value=""
                                            readonly>
                                    </div>
                                    <div class="form-group">
...
$(function() {
    ...
    $('#id_hoc_phi').change(function() {
        if ($('#id_hoc_phi').val() != "selecthocky") {
            ...
            if ($('#chon_theo_lop_hoc_hien_tai').is(':checked')) {
                ...
                $.ajax({
                    type: "GET",
                    url: "{{env('SERVER_URL')}}/api/hocphi/danhsachsinhviendonghocphihocky/" +
                        hoc_ky + "/" + khoa_hoc,
                    ...
                    data.forEach(element => {
                        textOption = textOption + '<option value="' + element.sinh_vien
                            .ma_sv + '">' + element.sinh_vien.ma_sv + ' - ' + element
                            .sinh_vien.ten_sinh_vien + '</option>';
                        if (element.da_dong_hoc_phi == 0) {
                            text = text +
                                '<tr><td><div class="form-check"><span class="badge rounded-pill bg-warning text-dark">Chưa đóng</span></div></td><td><a href="#" class="xem_thong_tin_thanh_toan" data-ma-sv="' +
                                element.sinh_vien.ma_sv + '">' + element.sinh_vien
                                .ma_sv + '</a></td><td>' + element.sinh_vien
                                .ten_sinh_vien + '</td><td></td></tr>';
                        } else {
                            text = text +
                                '<tr><td><div class="form-check"><span class="badge rounded-pill bg-success">Đã đóng</span></div></td><td><a href="#" class="xem_thong_tin_thanh_toan" data-ma-sv="' +
                                element.sinh_vien.ma_sv + '">' + element.sinh_vien
                                .ma_sv + '</a></td><td>' + element.sinh_vien
                                .ten_sinh_vien +
                                '</td><td><a type="button" class="btn btn-danger huy-dong-hoc-phi" data-ma-sv="' +
                                element.sinh_vien.ma_sv + '" data-id-hoc-phi="' +
                                element.id_hoc_phi +
                                '" style="font-size:0.8em">Hủy đóng</a></td></tr>';
                        }
    ...
    $('#id_lop_hoc').change(function() {
        $.ajax({
            method: "GET",
            url: "{{env('SERVER_URL')}}/api/sinhvien/sinhvientheolophoc/" + $(this).val() +
                "/" + $('#id_hoc_phi option:selected').attr('data-hoc-ky') + "/" + $(
                    '#id_hoc_phi option:selected').attr('data-khoa-hoc'),
        }).done(function(data) {
            console.log(data);
            text = "";
            textOption = "";
            $sinhviens = data;
            data.forEach(element => {
                textOption = textOption + '<option value="' + element.sinh_vien.ma_sv +
                    '">' + element.sinh_vien.ma_sv + ' - ' + element.sinh_vien
                    .ten_sinh_vien + '</option>';
                if (element.da_dong_hoc_phi == 0) {
                    text = text +
                        '<tr><td><div class="form-check"><span class="badge rounded-pill bg-warning text-dark">Chưa đóng</span></div></td><td><a href="#" class="xem_thong_tin_thanh_toan" data-ma-sv="' +
                        element.sinh_vien.ma_sv + '">' + element.sinh_vien.ma_sv +
                        '</a></td><td>' + element.sinh_vien.ten_sinh_vien +
                        '</td><td></td></tr>';
                } else {
                    text = text +
                        '<tr><td><div class="form-check"><span class="badge rounded-pill bg-success">Đã đóng</span></div></td><td><a href="#" class="xem_thong_tin_thanh_toan" data-ma-sv="' +
                        ...
                        '</a></td><td>' + element.sinh_vien.ten_sinh_vien +
                        '</td><td><a type="button" class="btn btn-danger huy-dong-hoc-phi" data-ma-sv="' +
                        element.sinh_vien.ma_sv + '" data-id-hoc-phi="' + element
                        .id_hoc_phi +
                        '" style="font-size:0.8em">Hủy đóng</a></td></tr>';
                }
        ...
        $sinhviens.forEach(sinhvien => {
            ...
            if (sinhvien.sinh_vien.ma_sv == ma_sv) {
                ...
                if (sinhvien.da_dong_hoc_phi == 0) {
                    ...
                    $('#id_hinh_thuc_thanh_toan').val(thongtinthanhtoan.hinh_thuc_thanh_toan.id)
                        .trigger('change');
                    if (thongtinthanhtoan.hinh_thuc_thanh_toan.id == 1) {
                        $('#payment_id').val(thongtinthanhtoan.thong_tin_thanh_toan.payment_id);
                        $('#payer_email_address').val(thongtinthanhtoan.thong_tin_thanh_toan
                            .payer_email_address);
                        $('#payer_id').val(thongtinthanhtoan.thong_tin_thanh_toan.payer_id);
                        $('#gross_amount').val(thongtinthanhtoan.thong_tin_thanh_toan
                            .gross_amount);
                        ...
                        $('#currency_code').val(thongtinthanhtoan.thong_tin_thanh_toan
                            .currency_code);
                    ...
                    if (thongtinthanhtoan.hinh_thuc_thanh_toan.id == 2) {
                        ...
                        $('#vnp_BankCode').val(thongtinthanhtoan.thong_tin_thanh_toan
                            .vnp_BankCode);
                        $('#vnp_OrderInfo').val(thongtinthanhtoan.thong_tin_thanh_toan
                            .vnp_OrderInfo);
                        $('#vnp_PayDate').val(thongtinthanhtoan.thong_tin_thanh_toan
                            .vnp_PayDate);
                        $('#vnp_ResponseCode').val(thongtinthanhtoan.thong_tin_thanh_toan
                            .vnp_ResponseCode);
                        $('#vnp_TmnCode').val(thongtinthanhtoan.thong_tin_thanh_toan
                            .vnp_TmnCode);
                        $('#vnp_TransactionNo').val(thongtinthanhtoan.thong_tin_thanh_toan
                            .vnp_TransactionNo);
                        $('#vnp_TransactionStatus').val(thongtinthanhtoan.thong_tin_thanh_toan
    ...
    $('#btn-querydr').click(function() {
        ...
        $.ajax({
            method: "GET",
            url: '{{route('
            thanhtoanhocphi.getVNPayPaymentDetail ')}}',
            data: {
    ...
    $('#btn-paypal_querydr').click(function() {
        ...
        $.ajax({
            method: "GET",
            url: '{{route('
            thanhtoanhocphi.getPaypalOrderDetail ')}}',
            data: {
            ...
            try {
                ...
                $('#gross_amount').val(data.purchase_units[0].payments.captures[0]
                    .seller_receivable_breakdown.gross_amount.value);
                $('#paypal_fee').val(data.purchase_units[0].payments.captures[0]
                    .seller_receivable_breakdown.paypal_fee.value);
                $('#net_amount').val(data.purchase_units[0].payments.captures[0]
    ...
    function reloadDanhSachSinhVien() {
        if ($('#chon_theo_lop_hoc_hien_tai').is(':checked') == false) {
            ...
            $.ajax({
                type: "GET",
                url: "{{env('SERVER_URL')}}/api/hocphi/danhsachsinhviendonghocphihocky/" + hoc_ky +
                    "/" + khoa_hoc,
                ...
                data.forEach(element => {
                    ...
                    if (element.da_dong_hoc_phi == 0) {
                        ...
                        text = text +
                            ...
                            '</td><td><a type="button" class="btn btn-danger huy-dong-hoc-phi" data-ma-sv="' +
                            element.sinh_vien.ma_sv + '" data-id-hoc-phi="' + element
                            .id_hoc_phi + '" style="font-size:0.8em">Hủy đóng</a></td></tr>';
                    }
            ...
            $.ajax({
                method: "GET",
                url: "{{env('SERVER_URL')}}/api/sinhvien/sinhvientheolophoc/" + $('#id_lop_hoc').val() +
                    "/" + $('#id_hoc_phi option:selected').attr('data-hoc-ky') + "/" + $(
                        '#id_hoc_phi option:selected').attr('data-khoa-hoc'),
            }).done(function(data) {
                console.log(data);
