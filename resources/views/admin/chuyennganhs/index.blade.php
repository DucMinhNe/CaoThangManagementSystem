                ...
                <form id="postForm" name="postForm" class="form-horizontal">
                   <input type="hidden" name="id" id="id">
                    <div class="form-group">
                        <label for="ten_chuyen_nganh" class="col-sm-2 control-label">Tên Chuyên Ngành</label>
                        <div class="col-sm-12">
                            <input type="text" class="form-control" id="ten_chuyen_nganh" name="ten_chuyen_nganh" placeholder="Enter Name" value="" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="id_khoa" class="col-sm-2 control-label">Tên Khoa</label>
                        <div class="col-sm-12">
                            <input type="text" class="form-control" id="id_khoa" name="id_khoa" placeholder="Enter Name" value="" required>
                        </div>
                    </div>
