        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="card-body">
                    ...
                    <input type="text" class="form-control" id="ten_phong" name="ten_phong" placeholder="Tên Khoa" value="" required>
                    </div>
                    <div class="form-group">
                    <label for="mo_ta">Mô tả</label>
                    <input type="text" class="form-control" id="mo_ta" name="mo_ta" placeholder="Tên Khoa" value="" required>
                    </div>
                    <div class="form-group">
                    <label for="suc_chua">Sức Chứa</label>
                    <input type="text" class="form-control" id="suc_chua" name="suc_chua" placeholder="Tên Khoa" value="" required>
                    </div>
                    <div class="form-group" >
                        <label for="id_loai_phong" >Loại Phòng</label>
                        <select name="id_loai_phong" id="id_loai_phong" class="form-control select2" style="width: 100%;">
    ...
    if (buttonText === 'Hiển thị Trạng thái 0') {
        ...
        $('body').on('click', '.editBtn', function() {
            ...
            $.get("{{ route('phong.index') }}" + '/' + id + '/edit', function(data) {
                ...
                $('#id_loai_phong').val(data.id_loai_phong);
            })
        });
