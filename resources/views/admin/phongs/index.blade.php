                ...
                <form id="modalForm" name="modalForm" class="form-horizontal">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="mo_ta" name="mo_ta" placeholder="Tên Khoa"
                                value="" required>
                        </div>
                        <div class="form-group">
                            <label for="suc_chua">Sức Chứa</label>
                            <input type="text" class="form-control" id="suc_chua" name="suc_chua" placeholder="Tên Khoa"
                                value="" required>
                        </div>
                        <div class="form-group">
