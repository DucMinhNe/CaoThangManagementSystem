                                ...
                                <div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="ten_lop_hoc_phan"
                                            name="ten_lop_hoc_phan" value="" readonly>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="ten_giang_vien_1"
                                            name="ten_giang_vien_1" value="" readonly>
                                    </div>
                                    <div class="form-group">
                                        <label for="ten_giang_vien_2">Tên Giảng Viên 2</label>
                                        <input type="text" class="form-control" id="ten_giang_vien_2"
                                            name="ten_giang_vien_2" value="" readonly>
                                    </div>
                                    <div class="form-group">
                                        <label for="ten_giang_vien_3">Tên Giảng Viên 3</label>
                                        <input type="text" class="form-control" id="ten_giang_vien_3"
                                            name="ten_giang_vien_3" value="" readonly>
                                    </div>
                                    <div class="form-group">
                                        <label for="hoc_ky">Học kỳ</label>
                                        <select name="hoc_ky" id="hoc_ky" class="form-control select2"
                            ...
                            <div class="col">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="thu_trong_tuan" id="thu_trong_tuan" class="form-control select2"
                                            style="width: 100%;">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="id_tiet_bat_dau" id="id_tiet_bat_dau" class="form-control select2"
                                            style="width: 100%;">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="id_tiet_ket_thuc" id="id_tiet_ket_thuc"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="id_phong_hoc" id="id_phong_hoc" class="form-control select2"
                                            style="width: 100%;">
        ...
        for (let i = 0; i < $thoigianbieus.length; i = i + 1) {
            if ($thoigianbieus[i].id == $(this).val()) {
                for (let j = i; j < $thoigianbieus.length; j = j + 1) {
                    text = text + '<option value="' + $thoigianbieus[j].id + '">' + $thoigianbieus[j]
                        .stt + '</option>';
                }
                break;
            }
        ...
        if (flag == true) {
            ...
            $.ajax({
                ...
                if (response.status == 1) {
                    text = '<tr data-row-tkb="' + row + '"><td data-thu_trong_tuan="' +
                        thu_trong_tuan + '">' + $arrayThu[thu_trong_tuan - 1] +
                        '</td><td data-id-tiet-bat-dau="' + tiet_bat_dau.id +
                        '" data-id-tiet-ket-thuc="' + tiet_ket_thuc.id + '">' + tiet_bat_dau
                        .stt + ' -> ' + tiet_ket_thuc.stt + '</td><td >' + tiet_bat_dau
                        .thoi_gian_bat_dau + ' -> ' + tiet_ket_thuc.thoi_gian_ket_thuc +
                        '</td><td data-phong="' + phong_hoc.id + '">' + phong_hoc.ten_phong +
                        '</td><td data-hoc-ky="' + hoc_ky + '">' + hoc_ky +
                        '</td><td><a class="btn btn-warning remove-row" data-row-tkb="' + row +
                        '">Bỏ</a></td></tr>';
                    jsonOject = {
                        'thu_trong_tuan': thu_trong_tuan,
