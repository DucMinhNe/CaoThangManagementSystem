        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="card-body">
                    ...
                    <input type="text" class="form-control" id="ten_mon_hoc" name="ten_mon_hoc" placeholder="Tên Khoa" value="" required>
                    </div>
                    <div class="form-group" >
                    ...
                    <div class="form-group" >
                        ...
                        <select name="id_loai_mon_hoc" id="id_loai_mon_hoc" class="form-control select2" style="width: 100%;">
...
<script type="text/javascript">
    $(function() {
        ...
        var table = $('.data-table').DataTable({
            ...
            columns: [
                {data: 'id', name: 'id'},
                {data: 'ten_mon_hoc', name: 'ten_mon_hoc'},
                {data: 'ten_bo_mon', name: 'ten_bo_mon'},
                {data: 'ten_loai_mon_hoc', name: 'ten_loai_mon_hoc'},
